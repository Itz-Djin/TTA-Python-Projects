...
class ParentWindow(Frame):
    def __init__ (self, master):
        ...
        self.btnSubmit = Button(self.master, text="Submit", width=10, height=2, bg='lightgreen', command=self.submit)
        self.btnSubmit.grid(row=2, column=1, padx=(0,0), pady=(30,0), sticky=NE)

        self.btnCancel = Button(self.master, text="Cancel", width=10, height=2, bg='red', command=self.cancel)
